...
class Login:
    def __init__(self, root):
        ...
        # Buttons
        btn_reg = Button(login_frame, text="Register New Account?", font=("times new roman", 14),
                         bg="white", bd=0, fg="#B00857", cursor="hand2", command=self.register)
        btn_reg.place(x=250, y=320)

        btn_login = Button(login_frame, text="Sign In", font=("times new roman", 20, "bold"),
                           fg="white", bd=0, bg="#B00857", cursor="hand2", command=self.login)
        ...
        btn_forget = Button(login_frame, text="Forget Password?", font=("times new roman", 12),
                            bg="white", bd=0, fg="#B00857", cursor="hand2", command=self.forgot_password)
    ...
    def forgot_password(self):
        ...
        try:
            ...
            if row is None:
                ...
                Label(self.root2, text="Reset Password", font=("times new roman", 22, "bold"),
                      bg="#1a1a2e", fg="#e94560").pack(pady=10)

                Label(self.root2, text="Security Question:", font=("times new roman", 16, "bold"),
                ...
                Label(self.root2, text="Answer:", font=("times new roman", 16, "bold"),
                      bg="#1a1a2e", fg="white").pack(pady=5)
                self.security_a_entry = Entry(self.root2, font=("times new roman", 14))
                self.security_a_entry.pack(pady=5, padx=20, fill=X)

                Label(self.root2, text="New Password:", font=("times new roman", 16, "bold"),
                      bg="#1a1a2e", fg="white").pack(pady=5)
