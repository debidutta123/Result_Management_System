...
class Course:
    def __init__(self, root):
        ...
        # Widgets
        lbl_courseName = Label(self.root, text="Course Name:", font=("goudy old style", 15, "bold"),
        ...
        self.txt_charges = Entry(self.root, textvariable=self.var_charges, font=("goudy old style", 15, "bold"),
